...
function Navbar(){
    ...
    return <div className="navbar-container">
        ...
        <div className="navbar-searchbar">
            ...
            <input className="navbar-input-location" placeholder="Find Places"></input>
            ...
            <img className="navbar-search-vertical "src={vertical} alt="vertical line"/>
            ...
            <input className="navbar-input-search" placeholder="Search for restaurant,cuisine, or a dish"></input>
